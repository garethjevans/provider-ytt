# ====================================================================================
# Setup Project
PROJECT_NAME := provider-ytt
PROJECT_REPO := github.com/garethjevans/$(PROJECT_NAME)
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Ytt CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Ytt controllers
...
# This target prepares repo for your provider by replacing all "ytt"
